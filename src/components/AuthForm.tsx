...
import { logAuthProviderStatus } from '../utils/testSocialAuth';
...
const AuthForm: React.FC = () => {
  ...
  const handleSocialLogin = async (provider: 'google' | 'apple' | 'azure' | 'facebook' | 'github') => {
    setLoading(true);
    setError(null);
    ...
    <div className="max-w-md mx-auto mt-8 p-6 bg-white/90 rounded-2xl shadow-lg">
      ...
      <div className="space-y-3 mb-6">
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 bg-gray-800 text-white py-3 px-4 rounded-lg hover:bg-gray-900 transition disabled:opacity-50"
        >
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
